...
public class Date {
	...
	private Countries country = Countries.ITALY;
	...
	public Date(int day, int month, int year) {
		...
		// se checkValidity() ritorna false
		// allora la data non è legale e lancio
		// una eccezione
		if (!checkValidity()) {
			// la data non è valida: lancio un'eccezione
