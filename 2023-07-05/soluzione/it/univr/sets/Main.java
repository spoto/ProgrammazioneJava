...
public class Main {
	...
	private Main(String[] names) {
		...
		PunishableSet<String> set1 = new PunishableSet<>(names);
		play("set1", set1);
		...
		// Samatha 7 punti ecc.)
		PunishableSet<String> set2 = new PunishableSet<>(names, String::length);
		play("set2", set2);

		// crea un PunishableSet contenente names inizializzati a una
		// quantita' di punti pari al proprio numero di vocali (cioè Fausto 3 punti,
		// Giulio 4 punti ecc.)
		PunishableSet<String> set3 = new PunishableSet<>(names, this::countVowels);
		play("set3", set3);

		// crea un PunishableSet contenente names inizializzati a 2000 punti
		PunishableSet<String> set4 = new PunishableSet<>(names, name -> 2000);
		play("set4", set4);
		...
		PunishableSet<String> set5 = new PunishableSet<>(names, name -> 600, this::adding, this::removing);
		play("set5", set5);
