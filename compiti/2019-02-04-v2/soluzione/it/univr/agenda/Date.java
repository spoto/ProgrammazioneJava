...
public abstract class Date implements Comparable<Date> {
	...
	public boolean equals(Object other) {
		return other instanceof Date && ((Date) other).daysAfterStartOf1900 == daysAfterStartOf1900;
	}

	@Override
	public int hashCode() {
		return daysAfterStartOf1900;
	}

	@Override
	public int compareTo(Date other) {
		return daysAfterStartOf1900 - other.daysAfterStartOf1900;
	}
